<template>
	<view class="u-switch" :class="[value == this.activeValue ? 'u-switch--on' : '', disabled ? 'u-switch--disabled' : '']" @tap="onClick"
	 :style="[switchStyle]">
...
<script>
	...
	export default {
		...
		computed: {
			...
			loadingColor() {
				return this.value == this.activeValue ? this.activeColor : null;
			}
		},
		methods: {
			onClick() {
